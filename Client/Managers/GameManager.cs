...
using Bitspoke.GodotEngine.Components.Settings.Graphics;
...
namespace Client.Managers
{
    ...
    public partial class GameManager : GodotNode2D
    {
        ...
        private void LoadDefaultSettings()
        {
            ...
            LudusGameSettingsComponent.Instance.GraphicsSettingsComponent.VSyncMode = DisplayServer.VSyncMode.Disabled;
